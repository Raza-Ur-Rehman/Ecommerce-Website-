...
const Header = () => {
  ...
  return (
    <>
      <div className="flex shadow-md rounded-xl p-3 items-center justify-between w-full h-auto"
      >
        <div className=" cursor-pointer w-full">
          ...
          <div class="relative ltr:ml-2 rtl:mr-2 ltr:lg:ml-0 rtl:lg:mr-0 z-10 w-[140px] sm:w-[150px] lg:w-[130px] xl:w-[150px]">
            ...
            >
              ...
              <span class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-1.5 rtl:pl-1.5 pointer-events-none">
                <svg
                  stroke="currentColor"
                  fill="none"
                  stroke-width="2"
            ...
            >
              ...
              >
                <span class="flex items-center">
                  ...
                  <span class="font-normal block truncate ltr:ml-1.5 rtl:mr-1.5">
                    عربى - AR
                  </span>
                </span>
              </li>
              ...
              <li
                class="text-amber-900 bg-gray-100
												cursor-pointer select-none relative py-2 px-3"
              ...
              >
                <span class="flex items-center">
                  ...
                  <span class="font-medium block truncate ltr:ml-1.5 rtl:mr-1.5">
                    English - EN
                  </span>
                  <span
        ...
        <div className="lg:flex hidden w-full">
          <div className="flex gap-12 text-xl font-normal w-1/2 ">
            <NavLink to="/">
              <h3>Home</h3>
          ...
          {/* w-2/6 */}
          <div className="w-1/2">
            <div className="flex w-full px-6 font-medium justify-center gap-2">
              <NavLink>
